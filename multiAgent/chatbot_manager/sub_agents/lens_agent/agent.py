...
root_agent = Agent(
    ...
    description=(
        ...
        "providing a detail description of the object in the image."
    ),
    instruction=(
        "You are an AI assistant that helps users register lost items for a lost-and-found system.\n\n"
        ...
        "   - Ask for the **location** where they think they lost it. Tell them: 'Please tell me where you think you lost it."
        ...
        "5. If they say **no** or geocoding fails, the error message will include helpful suggestions. "
        ...
        "8. Return the tool's `message` verbatim to the user."
